...
void *liballoc_malloc_r(size_t size)
{
	int index;
	void *ptr;
	struct boundary_tag *tag = NULL;
...
void* liballoc_calloc_r(size_t nobj, size_t size)
{
   int real_size;
   void *p;
...
void* liballoc_realloc_r(void *p, size_t size)
{
	void *ptr;
	struct boundary_tag *tag;
	int real_size;
